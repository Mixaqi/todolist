...
class User(models.Model):
    ...
    assigned_tasks = models.ForeignKey('ToDo', on_delete=models.SET_NULL, null=True, blank=True, related_name='assigned_to_user')
...
class AttachedFile(models.Model):
    ...
    task = models.ForeignKey(ToDo, on_delete=models.CASCADE)  # Используем модель ToDo для связи
